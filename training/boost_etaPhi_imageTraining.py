...
print "This Program is plotting the Nachman method applied to Boosted Images"

# Load images from h5 file
h5f = h5py.File("data/etaPhiBoostedJetImages.h5","r")
...
if savePDF == True:
   plt.savefig('plots/boost_EtaPhi_confusion_matrix.pdf')
if savePNG == True:
   plt.savefig('plots/boost_EtaPhi_confusion_matrix.png')
plt.close()
...
tools.plotPerformance(loss, acc, "boost_EtaPhi")
print "plotted HESTIA training Performance"

# make file with probability results
joblib.dump(model_BESTNN, "HHESTIA_keras_boost_EtaPhi.pkl")
