...
# Load Weights
model_BESTNN.load_weights("boost_CosTheta_10by10_model.h5")
...
layer_names = []
for layer in model_BESTNN.layers[:6]:
...
for layer_name, layer_activation in zip(layer_names, activations): # Displays the feature maps
    ...
    plt.savefig("plots/boost_CosTheta_10by10_ConvVis_"+layer_name+".png")
